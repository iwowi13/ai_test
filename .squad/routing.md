...
|-----------|----------|----------|
| Architecture, planning, scope, code review | 🏗️ Mal | Project structure, folder layout, API contract, commit gating |
| Angular / frontend / UI | ⚛️ Inara | Components, routing, forms, carousel, admin views, auth UI, frontend README |
| FastAPI / Python / Postgres / auth | 🔧 Kaylee | Endpoints, models, migrations, JWT, image upload, backend README |
| Tests (front + back) and quality gates | 🧪 River | pytest, Angular tests, edge cases, reviewer verdicts |
| Code review | 🏗️ Mal | Reviews diffs before commits land |
| Testing | 🧪 River | Writes tests, finds edge cases, verifies fixes |
| Scope & priorities | 🏗️ Mal | What to build next, trade-offs, decisions |
